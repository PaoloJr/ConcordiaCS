section .bss
    buffer resb 4  ; Reserve 10 bytes for input buffer
    int_str resb 4 ; Buffer to store the integer string
...
_start:
    ...
    jmp convert_loop    ; jump to conversion loop

check_plus:
    cmp cl, '+'         ; check if it's a plus sign
    jne convert_loop    ; if not, proceed to conversion loop
    inc esi             ; move to the next character
