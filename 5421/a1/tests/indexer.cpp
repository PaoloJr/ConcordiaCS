...
void testProcessTextFile() {
    cout << "Testing processTextFile method... ";
...
void testSearchByLength() {
    cout << "Testing searchByLength method... " << endl;
    ...
    cout << "searchByLenght() completed." << endl;
}

// Test displaySection method
void testDisplaySection() {
    cout << "Testing displaySection method..." << endl;
...
void testGetTokenCount() {
    cout << "Testing getTokenCount method... ";
