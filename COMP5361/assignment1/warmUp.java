...
public class warmUp {
    ...
    private static boolean[] getValidBooleans(Scanner scanner) {
        while (true) {
            ...
            if (inputs.length == 1 || inputs.length == 2) {
                try {
                    boolean value1 = parseBoolean(inputs[0]);
                    if (inputs.length == 2) {
                        boolean value2 = parseBoolean(inputs[1]);
   ...
   private static boolean parseBoolean(String input) {
    ...
    public static void main(String[] args) {
        ...
        boolean[] values = getValidBooleans(scanner);
